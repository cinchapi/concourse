...
public abstract class Concourse implements AutoCloseable {
    ...
    private final static class Client extends Concourse {
        ...
        @Override
        public BigDecimal sum(final String key, final long record) {
            return execute(new Callable<BigDecimal>() {

                @Override
                public BigDecimal call() throws Exception {
                    TObject object = client.sumKeyRecord(key, record, creds,
                            transaction, environment);
        ...
        public BigDecimal sum(final String key) {
            return execute(new Callable<BigDecimal>() {
                ...
                @Override
                public BigDecimal call() throws Exception {
                    TObject object = client.sumKey(key, creds, transaction,
                            environment);
                    return new BigDecimal(
                            Convert.thriftToJava(object).toString());
                }
        ...
        @Override
        public BigDecimal sum(final String key, final Timestamp timestamp) {
            return execute(new Callable<BigDecimal>() {
        ...
        public BigDecimal sum(final String key, final Criteria criteria) {
            return execute(new Callable<BigDecimal>() {
                ...
                @Override
                public BigDecimal call() throws Exception {
                    TObject object = client.sumKeyCriteria(key,
                            Language.translateToThriftCriteria(criteria), creds,
                            transaction, environment);
                    return new BigDecimal(
                            Convert.thriftToJava(object).toString());
        ...
        @Override
        public BigDecimal sum(final String key, final String ccl) {
            return execute(new Callable<BigDecimal>() {
