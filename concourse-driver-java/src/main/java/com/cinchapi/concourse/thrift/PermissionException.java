...
public class PermissionException extends TException implements org.apache.thrift.TBase<PermissionException, PermissionException._Fields>, java.io.Serializable, Cloneable, Comparable<PermissionException> {
  ...
  static {
    schemes.put(StandardScheme.class, new PermissionExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PermissionExceptionTupleSchemeFactory());
  }
  ...
  private static class PermissionExceptionStandardScheme extends StandardScheme<PermissionException> {
  ...
  private static class PermissionExceptionTupleScheme extends TupleScheme<PermissionException> {
