...
public class ParseException extends GenericMessageException {
    private static String description = "Signals that an unexpected or invalid token was reached while parsing.";
    ...
    public ParseException(GenericMessageException other) {
        super(other);
    }
}
