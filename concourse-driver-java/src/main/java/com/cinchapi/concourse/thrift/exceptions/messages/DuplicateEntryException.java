...
public class DuplicateEntryException extends GenericMessageException {
    private static String description = "Signals that an attempt to conditionally add data based on"
    ...
    public DuplicateEntryException(GenericMessageException other) {
        super(other);
    }
}
