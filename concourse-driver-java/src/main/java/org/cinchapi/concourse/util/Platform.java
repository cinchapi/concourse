...
public final class Platform {
    ...
    /**
     * Return the ideal number of threads to use for a CPU bound task on this
     * platform.
     * 
     * @return the ideal number of threads to use
     */
    public static int idealNumberOfThreadsForCpuBoundTask() {
