...
@Grapes([
  @Grab('org.apache.thrift:libthrift:0.9.2'), @Grab('org.slf4j:slf4j-api:1.7.5'), @Grab('org.slf4j:slf4j-nop:1.7.12'), @Grab('org.codehaus.groovy:groovy-json:2.4.3')
  ])
...
TransactionToken transaction, String environment)
throws TException {
	Set < String > keys = describeRecord(record, creds, transaction, environment);
	for (String key: keys) {
...
String environment) throws TException {
	...
	return selectRecordsTime(records, timestamp, creds, transaction, environment);
}
...
AccessToken creds, TransactionToken transaction, String environment)
throws TException {
	return selectKeyCclTime(key, ccl, Time.now(), creds, transaction, environment);
}
...
String environment) throws TException {
	List < Long > records = new ArrayList < Long > (findCcl(ccl, creds, transaction, environment));
	return selectKeyRecordsTime(key, records, timestamp, creds, transaction, environment);
}
...
String timestamp, AccessToken creds, TransactionToken transaction,
String environment) throws TException {
	return selectKeyCclTime(key, ccl, Parser.parseMicros(timestamp), creds, transaction, environment);
}
...
TransactionToken transaction, String environment)
throws TException {
	return selectKeysCclTime(keys, ccl, Time.now(), creds, transaction, environment);
}
...
throws TException {
	List < Long > records = new ArrayList < Long > (findCcl(ccl, creds, transaction, environment));
	return selectKeysRecordsTime(keys, records, timestamp, creds, transaction, environment);
}
...
TransactionToken transaction, String environment)
throws TException {
	return selectKeysCclTime(keys, ccl, Parser.parseMicros(timestamp), creds, transaction, environment);
}
...
long record, AccessToken creds, TransactionToken transaction,
String environment) throws TException {
	return chronologizeKeyRecordStart(key, record, 0, creds, transaction, environment);
}
...
TransactionToken transaction, String environment)
throws TException {
	return chronologizeKeyRecordStartEnd(key, record, start, Time.now(), creds, transaction, environment);
}
...
long start, AccessToken creds, TransactionToken transaction,
String environment) throws TException {
	return diffKeyStartEnd(key, start, Time.now(), creds, transaction, environment);
}
...
throws TException {
	...
	Map < TObject, Set < Long >> startData = browseKeyTime(key, start, creds, transaction, environment);
	Map < TObject, Set < Long >> endData = browseKeyTime(key, tend, creds, transaction, environment);
