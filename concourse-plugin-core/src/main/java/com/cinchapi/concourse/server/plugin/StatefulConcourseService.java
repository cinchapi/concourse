...
abstract class StatefulConcourseService {
    ...
    public Map<Long,Map<String,Set<Object>>> selectKeysCriteriaOrder(List<String> keys, Criteria criteria, TOrder order) { throw new UnsupportedOperationException(); }
    ...
    public Map<Long,Map<String,Set<Object>>> selectKeysCriteriaTimeOrder(List<String> keys, Criteria criteria, long timestamp, TOrder order) { throw new UnsupportedOperationException(); }
    ...
    public Map<Long,Map<String,Set<Object>>> selectKeysCriteriaTimestrOrder(List<String> keys, Criteria criteria, String timestamp, TOrder order) { throw new UnsupportedOperationException(); }
