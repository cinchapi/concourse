...
abstract class StatefulConcourseService {
    ...
    public Map<Long,List<String>> reviewRecord(long record) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewRecordStart(long record, long start) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewRecordStartstr(long record, String start) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewRecordStartEnd(long record, long start, long tend) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewRecordStartstrEndstr(long record, String start, String tend) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewKeyRecord(String key, long record) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewKeyRecordStart(String key, long record, long start) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewKeyRecordStartstr(String key, long record, String start) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewKeyRecordStartEnd(String key, long record, long start, long tend) { throw new UnsupportedOperationException(); }

    public Map<Long,List<String>> reviewKeyRecordStartstrEndstr(String key, long record, String start, String tend) { throw new UnsupportedOperationException(); }
    ...
    public Map<String,Set<Long>> traceRecord(long record) { throw new UnsupportedOperationException(); }

    public Map<String,Set<Long>> traceRecordTime(long record, long timestamp) { throw new UnsupportedOperationException(); }

    public Map<String,Set<Long>> traceRecordTimestr(long record, String timestamp) { throw new UnsupportedOperationException(); }

    public Map<Long,Map<String,Set<Long>>> traceRecords(List<Long> records) { throw new UnsupportedOperationException(); }

    public Map<Long,Map<String,Set<Long>>> traceRecordsTime(List<Long> records, long timestamp) { throw new UnsupportedOperationException(); }

    public Map<Long,Map<String,Set<Long>>> traceRecordsTimestr(List<Long> records, String timestamp) { throw new UnsupportedOperationException(); }

    public boolean consolidateRecords(List<Long> records) { throw new UnsupportedOperationException(); }
