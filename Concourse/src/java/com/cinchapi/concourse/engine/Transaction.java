...
import com.cinchapi.concourse.engine.Value.Values;
	...
	public static class Operation {
		...
		private static class GsonTypeAdapter implements
			...
			public Operation deserialize(JsonElement json,
				...
				com.cinchapi.concourse.engine.Value.Type valueType = com.cinchapi.concourse.engine.Value.Type
						.values()[obj.get(VALUE_TYPE_MEMBER).getAsInt()];
				Object value = null;
				if(valueType == com.cinchapi.concourse.engine.Value.Type.BOOLEAN) {
					value = obj.get(VALUE_MEMBER).getAsBoolean();
				}
				else if(valueType == com.cinchapi.concourse.engine.Value.Type.DOUBLE) {
					value = obj.get(VALUE_MEMBER).getAsDouble();
				}
				else if(valueType == com.cinchapi.concourse.engine.Value.Type.FLOAT) {
					value = obj.get(VALUE_MEMBER).getAsFloat();
				}
				else if(valueType == com.cinchapi.concourse.engine.Value.Type.INTEGER) {
					value = obj.get(VALUE_MEMBER).getAsInt();
				}
				else if(valueType == com.cinchapi.concourse.engine.Value.Type.LONG) {
					value = obj.get(VALUE_MEMBER).getAsLong();
				}
				else if(valueType == com.cinchapi.concourse.engine.Value.Type.RELATION) {
