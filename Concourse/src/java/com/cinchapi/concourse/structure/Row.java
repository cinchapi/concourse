 ...
 * </p>
 * <p>
 * A row can hold up to {@value #MAX_NUM_CELLS} cells throughout its lifetime,
 * but in actuality this limit is lower because the size of a cell can very
 * widely and is guaranteed to increase with every revision. Therefore it is
 * more useful to use the maximum allowable storage for a row as a guide.
