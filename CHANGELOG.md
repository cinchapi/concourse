...
* Fixed a bug that caused Concourse Shell to fail to parse short syntax within statements containing an open parenthesis. [GH-463](https://github.com/cinchapi/concourse/issues/463)
