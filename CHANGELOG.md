...
* Added a % like functionality for REGEX and NOT_REGEX operators in find operation. For ex:
  		find("name", REGEX, "%Jeff%)
		And the result set should contain all records where the name key contains the substring "Jeff".
