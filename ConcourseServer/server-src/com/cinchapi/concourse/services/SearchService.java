...
public interface SearchService {
	...
	/**
	 * Remove all the <code>indices</code> for the <code>values</code> mapped
	 * from <code>key</code> on the {@link Entity} identified by <code>id</code>
	 * .
	 * 
	 * @param key
	 * @param id
	...
	/**
	 * Index the <code>values</code> mapped from <code>key</code> on the
	...
	/**
	 * Return every {@link Entity} in the <code>classifier</code> that have
	 * indexed <code>values</code> mapped from <code>key</code> and matching the
	 * <code>query</code>.
	 * 
	 * @param classifier
	 * @param key
