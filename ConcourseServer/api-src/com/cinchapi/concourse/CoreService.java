...
public interface CoreService {
	...
	/**
	 * Add a {@link Property} where the <code>key</code> maps to <code>value</code> for the {@link Entity} identified
	 * by <code>id</code>.
	 * @param key
	 * @param value
	 * @param id
	...
	/**
	 * Create a new {@link Entity} with the <code>classifier</code> and <code>title</code>.
	 * @param classifier
	 * @param title
	...
	/**
	 * Return <code>true</code> if there is an {@link Entity} identified by <code>id</code>.
	 * @param id
	...
	/**
	 * Get the values mapped from <code>key</code> on the {@link Entity} identified by <code>id</code>.
	 * @param key
	 * @param id
	...
	/**
	 * Remove the mapping of <code>key</code> to <code>value</code> for the {@link Entity} identified by <code>id</code>.
	 * @param key
	 * @param value
	 * @param id
	...
	/**
	 * Select each {@link Entity} in <code>classifier</code> that matches the <code>criteria</code>. 
	 * @param classifier
	 * @param criteria
	 * @return the <code>id</code> set.
	 */
	...
	/**
	 * Remove any existing <code>values</code> mapped from <code>key</code> and add a new {@link Property} where <code>key</code> 
	 * maps to <code>value</code> on the {@link Entity} identified by <code>id</code>.
	 * @param key
	 * @param value
	 * @param id
	 * @return <code>true</code> if the <code>property</code> is added.
