...
/**
 * An element that contains {@link Metadata} and a {@link PropertyRecord} set. 
 * @author jnelson
 *
 */
public interface Entity {
	 ...
	 * again, resulting in a new {@link Modification}.  
	 * @param property
	 * @return a {@link Modification} or <code>null</code> if the <code>property</code> cannot be added.
	 */
	 ...
	 * @param record
	 * @return a {@link Modification} or <code>null</code> if the {@link Property} cannot be removed (i.e
	...
	/**
	 * Return an {@link Iterator} over the <code>property</code> keys. Use {@link #get(String)} to get the
	 * {@link Property} set for each key.
	 * @return the <code>iterator</code>.
	 */
	public Iterator<String> keyIterator();
	
	/**
	 * Return an {@link Iterator} over each {@link Modification}.
	 * @return the <code>iterator</code>
	 */
