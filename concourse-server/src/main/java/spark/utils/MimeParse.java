 ...
 * 
 * Modified by Alex Soto <asotobu@gmail.com> to coform naming conventions and
...
public class MimeParse {
    ...
    protected static FitnessAndQuality fitnessAndQualityParsed(String mimeType,
        ...
        for (ParseResults range : parsedRanges) {
            if((target.type.equals(range.type) || range.type.equals("*")
                    || target.type.equals("*"))
    ...
    public static String bestMatch(Collection<String> supported,
        ...
        return Float.compare(lastOne.quality, 0) != 0 ? lastOne.mimeType
                : NO_MIME_TYPE;
    }
