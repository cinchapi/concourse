...
public interface SparkServer {
    ...
    /**
     * Ignites the spark server, listening on the specified port, running SSL
     * secured with the specified keystore
     ...
     * @param truststoreFile - the truststore file location as string, leave
     *            null to reuse keystore
     * @param truststorePassword - the trust store password
     * @param staticFilesRoute - the route to static files in classPath
     * @param externalFilesLocation - the route to static files external to
     *            classPath.
     */
