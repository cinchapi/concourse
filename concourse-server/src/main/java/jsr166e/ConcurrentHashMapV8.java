 ...
 * that the results of aggregate status methods including {@code size},
 * {@code isEmpty}, and {@code containsValue} are typically useful only when a
 * map is not undergoing concurrent updates in other threads. Otherwise the
 * results of these methods reflect transient states that may be adequate for
...
public class ConcurrentHashMapV8<K, V> extends AbstractMap<K, V>
     ...
     *         is a key in this table, as determined by the {@code equals}
                ...
                synchronized (f) {
                    if(tabAt(tab, i) == f) {
                        if(fh >= 0) {
                            ...
                            TreeNode<K, V> r, p;
                            if((r = t.root) != null && (p = r.findTreeNode(hash,
                                    key, null)) != null) {
                                V pv = p.val;
                                if(cv == null || cv == pv
     ...
     * {@code clear} operations. It does not
    ...
    public V computeIfAbsent(K key,
            Fun<? super K, ? extends V> mappingFunction) {
    ...
    public static <K> KeySetView<K, Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<K, Boolean>(
                new ConcurrentHashMapV8<K, Boolean>(initialCapacity),
                Boolean.TRUE);
    }

    /**
     * Returns a {@link Set} view of the keys in this map, using the
     * given common mapped value for any additions (i.e., {@link Collection#add}
     * and {@link Collection#addAll(Collection)}).
    ...
    private final void addCount(long x, int check) {
        CounterCell[] as;
        long b, s;
        if((as = counterCells) != null || !U.compareAndSwapLong(this, BASECOUNT,
                b = baseCount, s = b + x)) {
            CounterHashCode hc;
            CounterCell a;
            long v;
            ...
            if((hc = threadCounterHashCode.get()) == null || as == null
                    || (m = as.length - 1) < 0 || (a = as[m & hc.code]) == null
    ...
    static final class TreeBin<K, V> extends Node<K, V> {
                ...
                for (Node<K, V> e = first; e != null;) {
                    ...
                    if(((s = lockState) & (WAITER | WRITER)) != 0) {
                        ...
                        try {
                            ...
                            int ls;
                            do {}
                            while (!U.compareAndSwapInt(this, LOCKSTATE,
        ...
        static {
            try {
                ...
                LOCKSTATE = U
                        .objectFieldOffset(k.getDeclaredField("lockState"));
            }
            catch (Exception e) {
                throw new Error(e);
            }
    ...
    public <U> U search(long parallelismThreshold,
        ...
        return new SearchMappingsTask<K, V, U>(null,
                batchFor(parallelismThreshold), 0, 0, table, searchFunction,
    ...
    public long reduceToLong(long parallelismThreshold,
            ObjectByObjectToLong<? super K, ? super V> transformer, long basis,
    ...
    public int reduceToInt(long parallelismThreshold,
            ObjectByObjectToInt<? super K, ? super V> transformer, int basis,
    ...
    public double reduceKeysToDouble(long parallelismThreshold,
            ObjectToDouble<? super K> transformer, double basis,
    ...
    public long reduceKeysToLong(long parallelismThreshold,
            ObjectToLong<? super K> transformer, long basis,
            LongByLongToLong reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public int reduceKeysToInt(long parallelismThreshold,
            ObjectToInt<? super K> transformer, int basis,
            IntByIntToInt reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public double reduceValuesToDouble(long parallelismThreshold,
            ObjectToDouble<? super V> transformer, double basis,
            DoubleByDoubleToDouble reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public long reduceValuesToLong(long parallelismThreshold,
            ObjectToLong<? super V> transformer, long basis,
            LongByLongToLong reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public int reduceValuesToInt(long parallelismThreshold,
            ObjectToInt<? super V> transformer, int basis,
            IntByIntToInt reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public double reduceEntriesToDouble(long parallelismThreshold,
            ObjectToDouble<Map.Entry<K, V>> transformer, double basis,
            DoubleByDoubleToDouble reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public long reduceEntriesToLong(long parallelismThreshold,
            ObjectToLong<Map.Entry<K, V>> transformer, long basis,
            LongByLongToLong reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    public int reduceEntriesToInt(long parallelismThreshold,
            ObjectToInt<Map.Entry<K, V>> transformer, int basis,
            IntByIntToInt reducer) {
        if(transformer == null || reducer == null)
            throw new NullPointerException();
    ...
    abstract static class CollectionView<K, V, E>
         ...
         * Adjacent elements are separated by the characters {@code ", "} (comma
     ...
     * {@link #newKeySet() newKeySet()}, {@link #newKeySet(int) newKeySet(int)}.
     * 
     * @since 1.8
     */
    ...
    static final class ForEachValueTask<K, V> extends BulkTask<K, V, Void> {
        ...
        ForEachValueTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Action<? super V> action) {
            super(p, b, i, f, t);
            this.action = action;
        }
    ...
    static final class ForEachEntryTask<K, V> extends BulkTask<K, V, Void> {
        ...
        ForEachEntryTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Action<? super Entry<K, V>> action) {
            super(p, b, i, f, t);
            this.action = action;
        }
    ...
    static final class ForEachMappingTask<K, V> extends BulkTask<K, V, Void> {
        ...
        ForEachMappingTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, BiAction<? super K, ? super V> action) {
            super(p, b, i, f, t);
            this.action = action;
        }
    ...
    static final class ForEachTransformedKeyTask<K, V, U>
        ...
        ForEachTransformedKeyTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Fun<? super K, ? extends U> transformer,
                Action<? super U> action) {
            super(p, b, i, f, t);
    ...
    static final class ForEachTransformedValueTask<K, V, U>
        ...
        ForEachTransformedValueTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Fun<? super V, ? extends U> transformer,
                Action<? super U> action) {
            super(p, b, i, f, t);
            this.transformer = transformer;
            this.action = action;
    ...
    static final class ForEachTransformedEntryTask<K, V, U>
        ...
        ForEachTransformedEntryTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Fun<Map.Entry<K, V>, ? extends U> transformer,
                Action<? super U> action) {
            super(p, b, i, f, t);
            this.transformer = transformer;
            this.action = action;
    ...
    static final class SearchValuesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        SearchValuesTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Fun<? super V, ? extends U> searchFunction,
                AtomicReference<U> result) {
            super(p, b, i, f, t);
            this.searchFunction = searchFunction;
            this.result = result;
    ...
    static final class SearchEntriesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        SearchEntriesTask(BulkTask<K, V, ?> p, int b, int i, int f,
                Node<K, V>[] t, Fun<Entry<K, V>, ? extends U> searchFunction,
                AtomicReference<U> result) {
            super(p, b, i, f, t);
            this.searchFunction = searchFunction;
            this.result = result;
        ...
        public final void compute() {
            ...
            if((reducer = this.reducer) != null) {
                ...
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") ReduceKeysTask<K, V> t = (ReduceKeysTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        K tr, sr;
                        if((sr = s.result) != null)
    ...
    static final class ReduceEntriesTask<K, V>
        ...
        public final void compute() {
            ...
            if((reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") ReduceEntriesTask<K, V> t = (ReduceEntriesTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        Map.Entry<K, V> tr, sr;
                        if((sr = s.result) != null)
    ...
    static final class MapReduceKeysTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceKeysTask<K, V, U> t = (MapReduceKeysTask<K, V, U>) c,
                            s = t.rights;
                    while (s != null) {
                        U tr, sr;
                        if((sr = s.result) != null)
    ...
    static final class MapReduceValuesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceValuesTask<K, V, U> t = (MapReduceValuesTask<K, V, U>) c,
                            s = t.rights;
                    while (s != null) {
                        U tr, sr;
                        if((sr = s.result) != null)
    ...
    static final class MapReduceEntriesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceEntriesTask<K, V, U> t = (MapReduceEntriesTask<K, V, U>) c,
                            s = t.rights;
                    while (s != null) {
                        U tr, sr;
                        if((sr = s.result) != null)
    ...
    static final class MapReduceMappingsTask<K, V, U>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceMappingsTask<K, V, U> t = (MapReduceMappingsTask<K, V, U>) c,
                            s = t.rights;
                    while (s != null) {
                        U tr, sr;
                        if((sr = s.result) != null)
    ...
    static final class MapReduceKeysToDoubleTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceKeysToDoubleTask<K, V> t = (MapReduceKeysToDoubleTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
    ...
    static final class MapReduceValuesToDoubleTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceValuesToDoubleTask<K, V> t = (MapReduceValuesToDoubleTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceMappingsToDoubleTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceMappingsToDoubleTask<K, V> t = (MapReduceMappingsToDoubleTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceKeysToLongTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceKeysToLongTask<K, V> t = (MapReduceKeysToLongTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceValuesToLongTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceValuesToLongTask<K, V> t = (MapReduceValuesToLongTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceEntriesToLongTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceEntriesToLongTask<K, V> t = (MapReduceEntriesToLongTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceMappingsToLongTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceMappingsToLongTask<K, V> t = (MapReduceMappingsToLongTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceKeysToIntTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceKeysToIntTask<K, V> t = (MapReduceKeysToIntTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceValuesToIntTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceValuesToIntTask<K, V> t = (MapReduceValuesToIntTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceEntriesToIntTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceEntriesToIntTask<K, V> t = (MapReduceEntriesToIntTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceMappingsToIntTask<K, V>
        ...
        public final void compute() {
            ...
            if((transformer = this.transformer) != null
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    @SuppressWarnings("unchecked") MapReduceMappingsToIntTask<K, V> t = (MapReduceMappingsToIntTask<K, V>) c,
                            s = t.rights;
                    while (s != null) {
                        t.result = reducer.apply(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static {
        try {
            ...
            TRANSFERINDEX = U
                    .objectFieldOffset(k.getDeclaredField("transferIndex"));
