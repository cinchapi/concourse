...
public final class Buffer extends Limbo implements InventoryTracker {
    ...
    private void addPage(boolean sync) {
        ...
        try {
            ...
            Logger.debug("Added pagination {} to Buffer", currentPage);
        }
        finally {
            structure.unlock();
        }
    ...
    /**
     * Remove the first pagination in the Buffer.
     */
    ...
    private static class OnDiskIterator extends ReadOnlyIterator<Write> {
        ...
        /**
         * Flip to the next pagination in the iterator.
         */
        private void flip() {
            if(fileIt.hasNext()) {
    ...
    private class Page implements Iterator<Write>, Iterable<Write> {
         ...
         * possible that a key exists on the pagination.
         */
        private final boolean[] keyCache;

        /**
         * A bloom filter like cache that is used to help determine if it is
         * possible that a key/record exists on the pagination.
         */
        private final boolean[] keyRecordCache;

        /**
         * A bloom filter like cache that is used to help determine if it
         * possible that a record exists on the pagination.
         */
        ...
        /**
         * A bloom filter like cache that is used to help determine if it
         * possible that a Write exists on the pagination.
         */
        ...
        public void delete() {
            ...
            Logger.info("Deleting Buffer pagination {}", filename);
        }
        ...
        public long getOldestWriteTimestamp() {
            ...
            // When there is no data on the pagination return the max possible
         ...
         * is necessary to iterate through the pagination for reading.
         * </p>
         */
        /*
         * (non-Javadoc)
        ...
        /**
         * Dump the contents of this pagination.
         * 
         * @return the dump string
         */
    ...
    private abstract class SeekingIterator implements Iterator<Write> {
        ...
        /**
         * A reference to the pagination in which the iterator is currently
         * traversing.
         */
         ...
         * state to turn to the first pagination and get the first write.
         */
        protected void init() {
            if(useable) {
                flip(true);
        ...
        /**
         * Flip to the next pagination in the Buffer.
         */
        private void flip() {
            flip(false);
        }
