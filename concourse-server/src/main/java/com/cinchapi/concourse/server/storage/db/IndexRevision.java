 ...
 */
@Immutable
public final class IndexRevision extends Revision<Text, Value, Identifier> {
     ...
     * @param version
     */
    IndexRevision(Text locator, Value key, Identifier value, long version,
            Action type) {
    ...
    @Override
    protected Class<Identifier> xValueClass() {
