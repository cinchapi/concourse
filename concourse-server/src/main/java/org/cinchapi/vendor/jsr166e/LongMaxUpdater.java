 ...
 * variables may grow dynamically to reduce contention. Method {@link #max} (or,
 * equivalently, {@link #longValue}) returns the current
...
public class LongMaxUpdater extends Striped64 implements Serializable {
    ...
    /**
     * Returns the {@link #max} as a {@code float} after a widening primitive
     * conversion.
     */
