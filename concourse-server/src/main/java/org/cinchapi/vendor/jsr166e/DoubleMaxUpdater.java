...
/**
 * One or more variables that together maintain a running {@code double} maximum
 * with initial value {@code Double.NEGATIVE_INFINITY}. When
 ...
 * 
 * <p>
 * <em>org.cinchapi.vendor.jsr166e note: This class is targeted to be placed in
...
public class DoubleMaxUpdater extends Striped64 implements Serializable {
    ...
    public void update(double x) {
        ...
        if((as = cells) != null
            ...
            if((hc = threadHashCode.get()) == null
                    ...
                    || (n = as.length) < 1
                    || (a = as[(n - 1) & hc[0]]) == null
                    || (Double.longBitsToDouble(v = a.value) < x && !(uncontended = a
                            .cas(v, lx))))
    ...
    /**
     * Returns the current maximum. The returned value is <em>NOT</em> an atomic
    ...
    /**
     * Resets variables maintaining updates to {@code Double.NEGATIVE_INFINITY}.
    ...
    /**
     * Equivalent in effect to {@link #max} followed by {@link #reset}. This
     * method may apply for example during quiescent
     * points between multithreaded computations. If there are
     * updates concurrent with this method, the returned value is <em>not</em>
    ...
    /**
     * Returns the {@link #max} as a {@code float} after a narrowing primitive
     * conversion.
     */
