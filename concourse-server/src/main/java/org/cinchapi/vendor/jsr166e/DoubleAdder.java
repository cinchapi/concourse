 ...
 * sum. When updates (method {@link #add}) are
 * contended across threads, the set of variables may grow dynamically
 * to reduce contention. Method {@link #sum} (or, equivalently
 * {@link #doubleValue}) returns the current total combined across the
