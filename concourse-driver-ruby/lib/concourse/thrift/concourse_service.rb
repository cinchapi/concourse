  ...
  module Thrift
    module ConcourseService
      class Client
        ...
        def send_inspect()
          send_message('inspect', Inspect_args)
        end

        def recv_inspect()
          result = receive_message(Inspect_result)
          return result.success unless result.success.nil?
          raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'inspect failed: unknown result')
        end
        ...
        def recv_insertJson()
          ...
          raise result.ex3 unless result.ex3.nil?
          raise result.ex4 unless result.ex4.nil?
          raise result.ex5 unless result.ex5.nil?
        ...
        def invokeManagement(method, params, creds)
          send_invokeManagement(method, params, creds)
          return recv_invokeManagement()
        end

        def send_invokeManagement(method, params, creds)
          send_message('invokeManagement', InvokeManagement_args, :method => method, :params => params, :creds => creds)
        end

        def recv_invokeManagement()
          result = receive_message(InvokeManagement_result)
          return result.success unless result.success.nil?
          raise result.ex unless result.ex.nil?
          raise result.ex2 unless result.ex2.nil?
          raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'invokeManagement failed: unknown result')
        end
      ...
      class Processor
        ...
        def process_addKeyValue(seqid, iprot, oprot)
          ...
          begin
            ...
            result.ex3 = ex3
          rescue ::Concourse::PermissionException => ex4
            result.ex4 = ex4
          end
        ...
        def process_auditRecord(seqid, iprot, oprot)
          ...
          begin
            ...
            result.ex2 = ex2
          rescue ::Concourse::PermissionException => ex3
            result.ex3 = ex3
          end
        ...
        def process_inspect(seqid, iprot, oprot)
          args = read_args(iprot, Inspect_args)
          result = Inspect_result.new()
          result.success = @handler.inspect()
          write_result(result, oprot, 'inspect', seqid)
        end
        ...
        def process_login(seqid, iprot, oprot)
          ...
          begin
            ...
            result.ex = ex
          rescue ::Concourse::PermissionException => ex2
            result.ex2 = ex2
          end
        ...
        def process_insertJson(seqid, iprot, oprot)
          ...
          begin
            ...
            result.ex4 = ex4
          rescue ::Concourse::PermissionException => ex5
            result.ex5 = ex5
          end
        ...
        def process_invokeManagement(seqid, iprot, oprot)
          args = read_args(iprot, InvokeManagement_args)
          result = InvokeManagement_result.new()
          begin
            result.success = @handler.invokeManagement(args.method, args.params, args.creds)
          rescue ::Concourse::SecurityException => ex
            result.ex = ex
          rescue ::Concourse::ManagementException => ex2
            result.ex2 = ex2
          end
          write_result(result, oprot, 'invokeManagement', seqid)
        end
      ...
      class AddKeyValue_result
        ...
        FIELDS = {
          ...
          EX4 => {:type => ::Thrift::Types::STRUCT, :name => 'ex4', :class => ::Concourse::PermissionException}
        }
      ...
      class AuditRecord_result
        ...
        FIELDS = {
          ...
          EX => {:type => ::Thrift::Types::STRUCT, :name => 'ex', :class => ::Concourse::SecurityException},
          EX2 => {:type => ::Thrift::Types::STRUCT, :name => 'ex2', :class => ::Concourse::TransactionException},
          EX3 => {:type => ::Thrift::Types::STRUCT, :name => 'ex3', :class => ::Concourse::PermissionException}
        }
      ...
      class Login_result
        ...
        FIELDS = {
          ...
          EX => {:type => ::Thrift::Types::STRUCT, :name => 'ex', :class => ::Concourse::SecurityException},
          EX2 => {:type => ::Thrift::Types::STRUCT, :name => 'ex2', :class => ::Concourse::PermissionException}
        }
      ...
      class InsertJson_result
        ...
        FIELDS = {
          ...
          EX5 => {:type => ::Thrift::Types::STRUCT, :name => 'ex5', :class => ::Concourse::PermissionException}
        }
      ...
      class InvokeManagement_result
        ...
        FIELDS = {
          SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Concourse::Thrift::ComplexTObject},
          EX => {:type => ::Thrift::Types::STRUCT, :name => 'ex', :class => ::Concourse::SecurityException},
          EX2 => {:type => ::Thrift::Types::STRUCT, :name => 'ex2', :class => ::Concourse::ManagementException}
        }
